...
不是那种"大纲"或"计划"，是一份**可以随时中止、随时恢复**的施工清单。
...
没有约束的 AI 像一匹野马——跑得快，但方向不可控。
有 tasks.md 的 AI 像一列火车——轨道限定了方向，速度反而能开到最大。
...
人与 AI 的对决，本质上是**上下文的对决**。

AI 的上下文在记忆里——不可靠、会遗忘、会编造。
你的上下文在文件里——可追踪、可恢复、可审计。
