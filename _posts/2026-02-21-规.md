...
对了说个题外话——我有次让 AI 自己写 tasks.md，结果它给自己安排了一项"优化 tasks.md 的格式"。递归了属于是。后来我加了条规则：tasks.md 的结构我定，你只管填内容。
...
你不信它的记忆就对了。哪怕你刚才聊了 50 轮，新开一轮对话它可能就忘了一半。但 tasks.md 在那里——白纸黑字，它不可能编。
